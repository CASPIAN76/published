"use strict";
(self["webpackChunkcrud_With_LocalStorage"] = self["webpackChunkcrud_With_LocalStorage"] || []).push([["main"],{
...
const routes = [
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_crud_crud_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./crud/crud.module */ 7995)).then(m => m.CrudModule) }
];
...
class AppComponent {
    constructor() {
        this.title = 'crud-With-LocalStorage';
    }
}
